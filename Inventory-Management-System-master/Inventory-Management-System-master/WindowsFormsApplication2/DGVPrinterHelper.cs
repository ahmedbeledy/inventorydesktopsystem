...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    class LogWriter
    {
        ...
        /// will impact performance, but ensures that messages are't lost
        /// </summary>
    ...
    public class DGVPrinter
    {
        ...
        public StringFormat GetRowHeaderCellFormat(DataGridView grid)
        {
            ...
            // if we do't already have a header cell format
            ...
            // if we still do't have a header cell format, create an empty
        ...
        {
            // get default values from provided data grid view, but only
            // if we do't already have a cell format
            ...
            // if we still do't have a cell format, create an empty
            if (null == cellformat)
        ...
        public void PrintPreviewNoDisplay(DataGridView dgv)
        {
            ...
            // if the caller has't provided a print preview dialog, then create one
        ...
        void SetupPrint()
        {
            ...
            // Set the default row header style where we do't have an override
            // and we do have rows
            ...
            foreach (DataGridViewColumn col in dgv.Columns)
            {
                ...
                // Set the default column header styles where we do't have an override
        ...
        private void SetupPrintRange()
        {
            ...
            // this is also used when printing specific pages or page ranges as we wo't know
            ...
            else
            {
                ...
                // select all visible rows and all visible columns - but do't include the new 'data entry row' 
        ...
        private void buildstringformat(ref StringFormat format, DataGridViewCellStyle controlstyle,
            ...
            StringTrimming trim)
        {
            // allocate format if it does't already exist
            if (null == format)
            ...
            // Check on right-to-left flag. This is set at the grid level, but does't show up 
            ...
            float basewidth, float overridewidth, StringFormat format)
        {
                ...
                (ColumnWidthSetting.Porportional == ColumnWidth))
            {
                    ...
                    && ("Image" == cell.ValueType.Name || "Byte[]" == cell.ValueType.Name))
                {
                    ...
                    // if we do't actually have a value, then just exit with a minimum size.
        ...
        private int Pagination()
        {
            ...
            // add in the page number height - does't matter at this point if it's printing on top or bottom
        ...
        private float PrintPageNo(Graphics g, float printpos)
        {
            if (pageno)
            {
                ...
                // if the page number is not on a separate line, do't "use up" it's vertical space
                if (pagenumberonseparateline)
        ...
        void DrawImageCell(Graphics g, DataGridViewImageCell imagecell, RectangleF rectf)
        {
            ...
            // if we do't actually have a value, then just exit.
            ...
            else if (DataGridViewImageCellLayout.Stretch == imagecell.ImageLayout)
            {
                ...
                // change the origin delta's to 0 so we do't move the image
                dx = 0;
                dy = 0;
            }
            else // DataGridViewImageCellLayout.Zoom
            {
                ...
                {
                    // use horizontal scale, do't move image horizontally
                    scale = horzscale;
                    dx = 0;
                ...
                {
                    // use vertical scale, do't move image vertically
                    scale = vertscale;
                    dy = 0;
